...
// apis imports
import { readAllRecipes, readRecipeByCategory, readSearchRecpie } from '../apis/recipes';
  ...
  return (
    <>
      ...
      <section className='text-center my-5'>
        <h1 className='font-semibold text-4xl my-10'>Recipes <span className='text-green'>Categories...</span></h1>
        <div className='flex flex-row justify-evenly items-center'>
          <CategoriesChip icon={breakfastIcon} title="Breakfast" handleClick={getRecipesByCategory}/>
          <CategoriesChip icon={lunchIcon} title="Starter" handleClick={getRecipesByCategory}/>
          <CategoriesChip icon={vegitarianIcon} title="Vegetarian" handleClick={getRecipesByCategory}/>
          <CategoriesChip icon={dessertIcon} title="Dessert" handleClick={getRecipesByCategory}/>
        </div>
      </section>
      <section className='px-0 sm:px-20 bg-lightGreen'>
        <div className='flex flex-row justify-between items-center '>
          <h1 className='font-semibold text-3xl m-5'>Latest <span className='text-green'>Recipes...</span></h1>
          <div className='flex mx-4'>
            <Input type="text" placeholder="Search Recipes..." handleChange={searchRecipes} />
