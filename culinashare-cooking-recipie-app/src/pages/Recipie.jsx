    ...
    <>
      ...
      <div className="sm:flex-nowrap flex flex-wrap m-5">
        <img
          ...
          alt="img"
          className="md:w-1/2 p-2 m-2 shadow-lg shadow-green"
        />
        <div className="flex flex-col my-5">
          ...
          <span className="text-green font-bold text-xl mx-5">
            {recipe.strCategory}
          </span>
          ...
          <div className="bg-lightGreen rounded-lg p-5">
            <h5 className="font-bold text-xl text-green">Instruction: </h5>
            <p className="leading-8">{recipe.strInstructions}</p>
          </div>
          <div className="p-4 border-2 border-green text-white bg-green my-10 font-bold text-center hover:text-green hover:bg-white">
